...
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/aquasecurity/libbpfgo)](https://github.com/cyberzz-dev/libbpfgo/releases)
[![Go Report Card](https://goreportcard.com/badge/github.com/cyberzz-dev/libbpfgo)](https://goreportcard.com/report/github.com/cyberzz-dev/libbpfgo)
[![License](https://img.shields.io/github/license/aquasecurity/libbpfgo)](https://github.com/cyberzz-dev/libbpfgo/blob/main/LICENSE)
...
```go
// initializing
import bpf "github.com/cyberzz-dev/libbpfgo"
...
...
- Feel free to ask questions by creating a new [Discussion](https://github.com/cyberzz-dev/libbpfgo/discussions), we'd love to help.
